  ...
  return (
    <main className="pageContainer">
      ...
      <section className="panel">
        ...
        <audio controls style={{ width: "100%", marginTop: 12 }} src="/test-tracks/subspot_mvp.wav">
          Your browser does not support the audio element.
        </audio>

        <div className={styles.actions} style={{ marginTop: 12 }}>
          <a className="cta ctaHighlight" href="/test-tracks/subspot_mvp.wav" download style={{ textAlign: "center" }}>
            Download WAV
          </a>
